...
#define LOGI(fmt, ...) HiLogPrint((LogType)3, (LogLevel)4, 0xD000F00u, LOG_TAG, fmt, ##__VA_ARGS__)
#define LOGE(fmt, ...) HiLogPrint((LogType)3, (LogLevel)6, 0xD000F00u, LOG_TAG, fmt, ##__VA_ARGS__)
