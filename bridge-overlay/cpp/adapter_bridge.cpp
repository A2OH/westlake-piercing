...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* /*reserved*/) {
    { int fd=open("/data/local/tmp/asx/btrace.log",O_WRONLY|O_CREAT|O_APPEND,0666);if(fd>=0){const char m[]="[TRACE] JNIONLOAD entered\n";write(fd,m,sizeof(m)-1);close(fd);} }
    ...
    #else
    { const char m[]="[JNIONLOAD] skipped skia\n"; write(2,m,sizeof(m)-1); }
    #endif
